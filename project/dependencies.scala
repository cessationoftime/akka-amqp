...
object dependencies {
  ...
  def Scalatest    = "org.scalatest" % "scalatest_2.11" % "2.2.1" % "test"   	  // ApacheV2
 // def scalaActorsForScalaTest = "org.scala-lang" % "scala-actors" % "2.10.1" % "test"
  ...
  def AkkaAgent = "com.typesafe.akka" % "akka-agent_2.11" % akkaVersion

  def Specs2      = "org.specs2" % "specs2_2.11" % "2.4.9" % "test"  // MIT
  def JUnit = "junit" % "junit" % "4.7" % "test"   																 // Common Public License 1.0
  def AkkaTestKit = "com.typesafe.akka" % "akka-testkit_2.11" % akkaVersion % "test"
